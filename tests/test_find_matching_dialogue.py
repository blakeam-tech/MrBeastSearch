...
class TestFindMatchingDialogue(unittest.TestCase):
    ...
    def test_find_matching_dialogue(self, mock_vectorizer, mock_literal_eval):
        ...
        instance.transform.return_value = ["vector1", "vector2", "vector3", "key_phrase_vector"]
        ...
        self.assertIn('Who will last the longest Keep your hand on the Lamborghini', result)
